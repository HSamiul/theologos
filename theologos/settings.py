"""
Django settings for theologos project.
...
SECRET_KEY = 'django-insecure-pp25=dey^5jv)3iqzn&q^ze363nawr)k3=(pkxcsn9yc_^tr0%'
...
WSGI_APPLICATION = 'theologos.wsgi.application'
